return {
    { -- extremely powerful fuzzy finder
        ...
        config = function()
            ...
            keymap.set("n", "<leader>fd", builtin.diagnostics, { desc = "Find diagnostics (nvim-telescope/telescope.nvim)" })
            keymap.set("n", "<leader>fr", builtin.resume, { desc = "Find resume (nvim-telescope/telescope.nvim)" })

            -- Keymaps for TODOs
            local todo = require("todo-comments")

            keymap.set("n", "<leader>ft", "<cmd>TodoTelescope<CR>", { desc = "Find todo items in workspace (folke/todo-comments.nvim)" })
            keymap.set("n", "]t", function() todo.jump_next() end, { desc = "Jump to next todo item (folke/todo-comments.nvim)" })
            keymap.set("n", "[t", function() todo.jump_prev() end, { desc = "Jump to previous todo item (folke/todo-comments.nvim)" })
        end,
    },
}
