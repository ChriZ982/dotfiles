...
keymap.set("n", "gl", function() vim.diagnostic.open_float({ source = true }) end,
...
keymap.set("n", "<leader>ci",
    ":lua if vim.opt_local.shiftwidth:get() == 2 then vim.opt_local.shiftwidth = 4; vim.opt_local.tabstop = 4 else vim.opt_local.shiftwidth = 2; vim.opt_local.tabstop = 2 end<CR>",
    { desc = "Toggle indent between 2 and 4 spaces", silent = true })
